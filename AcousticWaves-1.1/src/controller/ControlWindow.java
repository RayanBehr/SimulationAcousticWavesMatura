...
public class ControlWindow extends JFrame {
	...
	private JToggleButton tglbtnLive;

	private JLabel lblErrorText;

	private JSlider sliderSigmoidBase;

	private SpeedInfo speed;

	private JButton btnSimulationToggle;
	...
	public ControlWindow() {
		...
		textFieldSolidPath.setText("C:\\Users\\rayan\\git\\SimulationAcousticWavesMatura\\AcousticWaves-1.1\\src\\maps\\3.jpg");
		...
		btnImport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					lblErrorText.setText("invalid path");
		...
		separatorEmulatorInfo.setBounds(10, 517, 340, 2);
		...
		lblErrorText.setBounds(10, 600, 173, 14);
		...
		btnResetErrorMessage.setBounds(193, 596, 157, 23);
		...
		lblVisualMode.setBounds(10, 530, 82, 14);
		contentPane.add(lblVisualMode);

		JSeparator separatorVisualMode = new JSeparator();
		separatorVisualMode.setBounds(10, 583, 340, 2);
		...
		speed.setBounds(10, 402, 340, 111);
